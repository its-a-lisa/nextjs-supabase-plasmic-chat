...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 52M_F0RpAHXe/css
...
export type PlasmicButton__VariantMembers = {
  ...
  color: "blue" | "green" | "white" | "clear" | "link";
};
export type PlasmicButton__VariantsArgs = {
  ...
  color?: SingleChoiceArg<"blue" | "green" | "white" | "clear" | "link">;
};
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__luIFn)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__nUGz)}
                role={"img"}
              />
            ),
