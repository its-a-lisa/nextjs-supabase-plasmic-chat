...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: FeO9F9kqLFEu/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___5A3V8)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__ngPvW)}
              role={"img"}
            />
          ),
