...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: YZ171wOZRVPa/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox___1HfF7)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__dRm3H)}>
              <div className={classNames(projectcss.all, sty.freeBox__c4Czf)}>
                <h5
